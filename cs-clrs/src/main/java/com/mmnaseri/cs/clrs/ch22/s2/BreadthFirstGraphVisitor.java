...
public class BreadthFirstGraphVisitor<E extends EdgeDetails, V extends VertexDetails>
  ...
  private void visitSubGraph(
      Graph<E, V> graph, GraphVertexVisitor<E, V> visitor, Vertex<V> startingVertex) {
