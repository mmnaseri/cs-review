 ...
 * @since 1.0 (2016/03/07, 11:53)
 */
public class RecursiveMatrixMultiplierTest {

    @Test
    public void testSquareMultiplication() throws Exception {
        final MatrixMultiplier multiplier = new RecursiveMatrixMultiplier();
