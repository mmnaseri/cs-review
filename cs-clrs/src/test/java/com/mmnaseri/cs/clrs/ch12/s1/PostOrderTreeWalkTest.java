 ...
 * @since 1.0 (7/15/15, 1:10 PM)
 */
public class PostOrderTreeWalkTest extends BaseTreeWalkTest {

    @Test
    @Override
    public void testWalkingOnALeafNode() throws Exception {
        final BinaryTreeNode<Integer> node = create(10, null, null);
        final PostOrderTreeWalk<Integer, BinaryTreeNode<Integer>> walk = new PostOrderTreeWalk<>();
    ...
    public void testWalkingWithAFullTree() throws Exception {
        ...
        assertThat(callback.getLog().get(1).getValue(), is(13));
        assertThat(callback.getLog().get(2).getValue(), is(11));
        assertThat(callback.getLog().get(3).getValue(), is(15));
        assertThat(callback.getLog().get(4).getValue(), is(16));
        assertThat(callback.getLog().get(5).getValue(), is(14));
        assertThat(callback.getLog().get(6).getValue(), is(10));
    }
