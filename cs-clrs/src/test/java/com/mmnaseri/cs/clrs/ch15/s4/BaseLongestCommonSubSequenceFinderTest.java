 ...
 * @since 1.0 (7/21/15)
 */
public abstract class BaseLongestCommonSubSequenceFinderTest {

    protected abstract LongestCommonSubSequenceFinder<Integer> getFinder();
    ...
    public void testFunctionality(@SuppressWarnings("UnusedParameters") String name, Integer[] first, Integer[] second, Integer[] expected) throws Exception {
        final LongestCommonSubSequenceFinder<Integer> finder = getFinder();
